...
import org.lee.client.annotation.RPCService;
...
import org.lee.common.exception.rpc.RpcWrapperException;
...
import static org.lee.common.util.Reflects.*;
...
public class LocalServerWrapperManager {
            ...
            for (Object o : obj) {
                ...
                if (null != serviceWrappers && !serviceWrappers.isEmpty()) {
                    for (ServiceWrapper serviceWrapper : serviceWrappers) {
                        ...
                        RemotingTransporter remotingTransporter = RemotingTransporter.createRequestTransporter(PastorProtocol.PUBLISH_SERVICE, commonCustomHeader);
    ...
    class DefaultServiceWrapper implements ServiceWrapperWorker {
        ...
        public List<ServiceWrapper> create() {
            List<ServiceWrapper> wrappers = new ArrayList<ServiceWrapper>();
