...
import static org.lee.common.util.Constants.DEFAULT_CONNECTION_COUNT;
import static org.lee.common.util.Constants.DEFAULT_MAX_CALLCOUN_TINMINUTE;
import static org.lee.common.util.Constants.DEFAULT_WEIGHT;
...
public class ServiceWrapper {
    ...
    public String toString() {
        return "ServiceWrapper{" +
                ...
                ", mockDegradeServiceProvider=" + mockDegradeServiceProvider +
                ", serviceName='" + serviceName + '\'' +
                ", responsiblityName='" + responsiblityName + '\'' +
                ", methodName='" + methodName + '\'' +
                ", paramters=" + paramters +
                ", isSupportDegradeService=" + isSupportDegradeService +
                ", degradeServicePath='" + degradeServicePath + '\'' +
                ", degradeServiceDesc='" + degradeServiceDesc + '\'' +
                ", isVIPService=" + isVIPService +
                ", weight=" + weight +
                ", connCount=" + connCount +
                ", isFlowController=" + isFlowController +
                ", maxCallCountInMinute=" + maxCallCountInMinute +
                '}';
    }
